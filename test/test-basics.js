...
import { encode as encodeBlock, decode as decodeBlock } from 'multiformats/block'
...
describe('encrypted-block', () => {
  it('encrypt/decrypt raw block', async () => {
    ...
    same(Buffer.compare(value, eBlock.bytes) !== 0, true)
    ...
    same(Buffer.compare(dBlock.value, value), 0)
  })
})
